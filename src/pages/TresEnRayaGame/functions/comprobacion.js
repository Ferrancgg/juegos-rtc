...
export const comprobarGanador = (tablero) => {
  ...
  // Verificar si hay un empate (ningún ganador y tablero lleno)
  const tableroLleno = tablero.flat().every((casilla) => casilla !== null);
  if (tableroLleno) {
    return "Empate";
  }

  return null; // No hay ganador y el juego sigue
};
